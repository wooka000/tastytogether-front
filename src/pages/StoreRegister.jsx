...
import TypeModalButton from '../components/TypeModalButton'
import MenuModalButton from '../components/MenuModalButton'
import DaumPost from '../components/PostCode/DaumPost'
...
export default function StoreRegister ({showModal}) {
    ...
    <Article>
        <CheckInfo>
            <div>!</div>
            <p>새롭게 등록하려는 맛집이 테이스티투게더에 등록되어 있는지 확인해주세요.</p>
        </CheckInfo>
        <RegisterForm onSubmit={handleSubmit}>
            ...
            <TableLine>
                ...
                <div className="table_content">
                    <input className="input" type="text" placeholder="업체명을 적고 확인버튼을 눌러주세요" />
            ...
            <TableLine id="mapDiv">
                ...
                <div className="table_content">
                    ...
                    <input className="input" type="text" placeholder="000 - 0000 - 0000" />
                </div>
            </TableLine>
            <Map>
            ...
            <TableLine>
                ...
                <div className="table_content">
                    <span className="price">
                        <label htmlFor="price1">1만원대</label>
                        <input type="radio" id="price1" name="price" value="1만원대" />
                    </span>
                    <span className="price">
                        <label htmlFor="price2">2만원대</label>
                        <input type="radio" id="price2" name="price" value="2만원대" />
                    </span>
                    <span className="price">
                        <label htmlFor="price3">3만원대</label>
                        <input type="radio" id="price3" name="price" value="3만원대" />
                    </span>
                    <span className="price">
                        <label htmlFor="price4">4만원대</label>
                        <input type="radio" id="price4" name="price" value="4만원대" />
                    </span>
                    <span className="price">
                        <input type="radio" id="price0" name="price" value="기타" />
                        <label htmlFor="price0">기타</label>
                        <input type="text" id="customPrice" name="customPrice" value="" />
                    </span>
                </div>
            </TableLine>
            <TableLine>
                ...
                <div className="table_content">
                    <label className="parking" htmlFor="parkingOption1">
                        <span>무료주차 가능</span>
                        <input type="radio" id="parkingOption1" name="parkingOption" />
                    </label>
                    <label className="parking" htmlFor="parkingOption2">
                        <span>유료주차장 이용</span>
                        <input type="radio" id="parkingOption2" name="parkingOption" />
                    </label>
                    <label className="parking" htmlFor="parkingOption3">
                        <span>주차장 없음</span>
                        <input type="radio" id="parkingOption3" name="parkingOption" />
                    </label>
                </div>
            </TableLine>
            <TableLine>
                ...
                <div className="table_content">
                    <input className="time" type="text" value="" />시 
                    <input className="time" type="text" value="" />분 - 
                    <input className="time" type="text" value="" />시 
                    <input className="time" type="text" value="" />분
                </div>
            </TableLine>
